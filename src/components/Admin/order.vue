    ...
    <div class="category">
        ...
        >
            <Form :model="formData">
                ...
                <Row :gutter="32">
                    <Col span="24">
                        <Button type="error" style="margin-right: 30px" @click="modal1 = true" v-if="formData.info.status != 4" >取消订单</Button>
                        <Button type="success" v-if="formData.info.status == 0 || formData.info.status == 1"  @click="modal2 = true">已发货</Button>
                    </Col>
                </Row>
            </Form>
